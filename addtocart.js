...
function displayCart(){
	...
	cartdata='<table><tr><th>Product Name</th><th>Quantity</th><th>Price</th><th>total</th></tr>';
	 ...
	 for(i=0; i<inames.length ;i++){
		 ...
		 cartdata += "<tr><td>"+inames[i]+"</td><td>"+iqtyp[i]+"</td><td>"+iprice[i]+"</td><td>"+iqtyp[i]*iprice[i]+"</td><td>"<button onclick='delElement(" + i + ")'>delete</buton></td></tr>";
	 }
	 cardata+='<tr><td></td><td></td><td></td><td>'+total+"</td></tr></table>';
